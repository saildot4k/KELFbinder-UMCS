...
Update_InstTable("INSTALL/ASSETS/SYS_OSDMENU", "SYS-OSDMENU", MC_INST_TABLE.source, MC_INST_TABLE.target, MC_INST_TABLE.dirs)
...
Update_InstTable("INSTALL/ASSETS/APP_ESR-LAUNCHER"  , "APP_ESR-LAUNCHER"  , MC_INST_TABLE.source, MC_INST_TABLE.target, MC_INST_TABLE.dirs)
...
Update_InstTable("INSTALL/ASSETS/PS1_POPSLOADER"  , "PS1_POPSLOADER"  , MC_INST_TABLE.source, MC_INST_TABLE.target, MC_INST_TABLE.dirs)
